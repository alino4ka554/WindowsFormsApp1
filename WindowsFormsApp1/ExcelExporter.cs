...
namespace WindowsFormsApp1
{
    ...
    {
        private static List<Operation> PrepareOperations(ScheduleSolution solution)
        {
            return solution.Operations.Values
        ...
        private static void FillData(ExcelWorksheet sheet, List<Operation> operations)
        {
        ...
        private static void ApplyStyles(ExcelWorksheet sheet, int rowCount)
        {
        ...
        private static void CreateGanttChart(ExcelWorksheet sheet, int rowCount)
        {
        ...
        private static void FillReport(ExcelWorksheet sheet, Report report)
        {
        ...
        private static void AdjustColumns(ExcelWorksheet sheet)
        {
        ...
        public static void ExportToExcel(ScheduleSolution solution, string path)
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                var operations = PrepareOperations(solution);

                WriteHeaders(sheet);
                FillData(sheet, operations);
                ApplyStyles(sheet, operations.Count);
                CreateGanttChart(sheet, operations.Count);
                FillReport(sheet, new Report(solution));
                AdjustColumns(sheet);
